...
module.exports.update = (event, context, callback) => {
  ...
  const params = {
    ...
    UpdateExpression: 'SET #todo_fname = :text, #todo_lname= :text1,#todo_contact= :text2, #todo_password= :text3, #todo_github= :text4, #todo_linkedin= :text5, #todo_facebook= :text6 , #todo_other= :text7',
